...
// 5. what is storybaords behind the scene
 /**
  Behind the scene of storyboards are xml file which represent the element layout of th elements on the storyboard
  */
// 6. what is closure
//Closure is function that can be passed around like variable and can be used as a signature of another function
...
var  name:(String,String) -> String = {fname, lname in
    return "\(fname) \(lname)"
...
for letter in initialString {   // O(n)
